...
DIY Arlo base station replacement running on arlo-base (192.168.86.186). Cameras connect via TP-Link Omada EAP225 WiFi access point. System provides motion detection, recording, battery monitoring, and web-based status dashboard.
...
**Location:** `/home/randy/arlo-viewer/`
**Served at:** `https://security.thefarmers.org/` (via bore tunnel)
...
hostname        TEXT    -- Camera hostname (e.g., VMC4030-A41B6)
...
**Current Cameras:**
- Back Yard: `5EM1877DA41B6` / MAC: `cc:40:d0:8c:83:e9`
- Front Door: `4XH2727FA9075` / MAC: `a0:04:60:cf:3d:c6`
...
**SSID:** NETGEAR99
**Country Code:** EU (115 channels)
**DHCP:** Provided by dnsmasq on arlo-base via `enx00051b516407`
...
```json
{
  "serial_number": "5EM1877DA41B6",
  "friendly_name": "Back Yard",
  "hostname": "VMC4030-A41B6",
  "ip": "172.14.0.102",
  "mac_address": "cc:40:d0:8c:83:e9",
  "online": true,
  "armed": true,
  "battery_percent": 92,
...
**URL:** `https://security.thefarmers.org/status.html`
...
```yaml
CameraAliases:
  '5EM1877DA41B6': 'Back Yard'
  '4XH2727FA9075': 'Front Door'
```
...
```yaml
WebHookUrls:
  - 'https://ntfy.thefarmers.org/arlo-alerts'
```
...
**Previous Backups:**
- `/home/randy/backups/arlo-cam-api/20260101-*` - USB WiFi investigation period
- `/home/randy/backups/arlo-cam-api/20260102-*` - Pre-Omada configuration
...
### Bore Tunnels (to farmers.thefarmers.org)
- `bore local 3000 --to farmers.thefarmers.org` - Arlo viewer web interface
- `bore local 8080 --to farmers.thefarmers.org` - Ntfy notifications

### External Access:
- `https://security.thefarmers.org/` - Video viewer and status dashboard
- `https://ntfy.thefarmers.org/arlo-alerts` - Push notifications
...
- Check bore tunnel connection to farmers.thefarmers.org
